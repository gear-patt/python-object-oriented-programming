...
class Book:
    ...
    def __post_init__(self): # you may use this when you want to add additional attributes that might depend on the values of other attributes in the init function
